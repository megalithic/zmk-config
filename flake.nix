    ...
    in {
      devShells.${system}.default = pkgs.mkShell {
        ...
        shellHook = ''
          ...
          echo ""
          echo "  Project automation uses mise:"
          echo "    mise install     - install project tools"
          echo "    mise run check   - validate configuration"
          echo "    mise run build   - build with GitHub Actions"
          echo "    mise run flash   - flash both halves"
          echo ""
        '';
      };
    };
